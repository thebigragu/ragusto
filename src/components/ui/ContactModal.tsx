      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 max-h-[min(90svh,880px)] w-full max-w-xl overflow-y-auto rounded-3xl border border-white/10 bg-[#12141a]/95 p-6 shadow-2xl touch-pan-y dark md:p-8"
            ...
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                ...
                <h2
                  ...
                  className="mt-2 font-serif text-3xl tracking-tight text-white md:text-4xl"
                >
                  Get in touch
                </h2>
