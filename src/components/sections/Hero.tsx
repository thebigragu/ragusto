  ...
  return (
    <section className="relative flex min-h-[100svh] items-end overflow-hidden pb-16 pt-[calc(var(--nav-height)+2rem)] md:items-center md:pb-24">
      <div className="absolute inset-0">
        <HeroCanvas />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-bg via-bg/55 to-transparent md:from-bg/90 md:via-bg/35" />
      ...
      <div className="container-shell relative z-10 grid w-full gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
        <div className="max-w-4xl space-y-8">
          <motion.p
            className="font-display text-5xl leading-[0.95] tracking-tight sm:text-6xl md:text-7xl lg:text-8xl xl:text-[7.5rem]"
        ...
        >
          ...
          <div className="h-24 w-px bg-gradient-to-b from-fg to-transparent" />
        </motion.div>
      </div>
    </section>
  );
